  ...
  <div class="home-container">
    <div :class="['navbar', { 'navbar-solid': navbarSolid }]">
      ...
      <div class="navbar-links">
        ...
        <span class="nav-link" v-if="!userInfo" @click="goToRegister"
          >注册</span
        >
    ...
    <div class="hero-section">
      <!-- <div class="hero-image-slider">
        <div class="slider-wrapper" ref="sliderWrapper">
          <div class="slider-list" :style="sliderStyle">
            <img
      ...
      <div class="hero-content">
        ...
        <div class="cta-buttons">
          <el-button type="primary" size="large" @click="goToArticles"
            >浏览文章</el-button
          >
          <el-button size="large" @click="goToCreate" v-if="userInfo"
            >写文章</el-button
          >
          <el-button type="primary" size="large" @click="goToTags"
            >浏览标签</el-button
          >
        </div>
      </div>
    ...
    <div class="features">
      ...
      <div class="feature-card" @click="goToComment">
        <div class="icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
// const sliderSpeed = 1; // 每帧移动的像素

// // 计算一组图片的总高度
// const imgCount = sliderImages.length;
// const imgHeight = 100 + 8; // 单张图片高度+margin-bottom
// const totalHeight = imgCount * imgHeight;

// const sliderStyle = computed(() => ({
//   transform: `translateY(-${sliderPosition.value}px)`,
//   transition: "transform 0.03s linear",
// }));

// function startSlider() {
//   sliderTimer = setInterval(() => {
//     sliderPosition.value += sliderSpeed;
//     // 关键：到达一组图片高度时，瞬间回到0
//     if (sliderPosition.value >= totalHeight) {
...
.home-container {
  ...
  background: url("http://192.168.70.192:8082//upload/backgroud/backgroud.jpg")
...
.hero-image-slider {
  ...
  overflow: hidden;
  border-radius: 16px;
  box-shadow: 0 4px 16px rgba(110, 142, 251, 0.12);
  background: #fff;
  position: relative;
  flex-shrink: 0;
}
